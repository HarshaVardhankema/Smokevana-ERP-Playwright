...
return [
    ...
    */
    ...
    'product_gallery_path' => 'img/gallery',
    ...
    'sync_style' => env('SYNC_STYLE', 'normal'),

    // Slug(s) for the "Gift card" category. Products with is_gift_card=1 are hidden from
    // general catalog/API listings and only shown when viewing this category.
    'gift_card_category_slugs' => ['gift-code', 'gift-card'],
];