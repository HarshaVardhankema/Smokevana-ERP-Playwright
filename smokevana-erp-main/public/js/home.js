$(document).ready(function() {
    ...
    if ($('#quick_actions_dropdown').length > 0) {
        $('#quick_actions_dropdown').on('click', function(e) {
            e.stopPropagation();
            var menu = $('#quick_actions_menu');
            if (menu.is(':visible')) {
                menu.hide();
            } else {
                menu.show();
        ...
        $(document).on('click', function(e) {
            if (!$(e.target).closest('#quick_actions_dropdown, #quick_actions_menu').length) {
                $('#quick_actions_menu').hide();
            }
        });

        // Close dropdown when clicking on a menu item
        $('#quick_actions_menu a').on('click', function() {
            $('#quick_actions_menu').hide();
        });
    }
});
