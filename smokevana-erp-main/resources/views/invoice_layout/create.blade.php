...
<style>
.invoice-layout-form-page { background: #EAEDED; min-height: 100%; padding-bottom: 2rem; }
.invoice-layout-form-page .amazon-invoice-banner {
    background: linear-gradient(135deg, #232f3e 0%, #37475a 100%);
    border-radius: 10px; padding: 24px 28px; margin-bottom: 20px;
    box-shadow: 0 4px 14px rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.06);
    display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 16px;
}
.invoice-layout-form-page .amazon-invoice-banner .banner-inner { display: flex; align-items: center; gap: 18px; }
.invoice-layout-form-page .amazon-invoice-banner .banner-icon {
    width: 52px; height: 52px; min-width: 52px; border-radius: 10px; background: rgba(255,255,255,0.1);
    color: #fff; font-size: 24px; display: flex; align-items: center; justify-content: center;
}
.invoice-layout-form-page .amazon-invoice-banner .banner-text { display: flex; flex-direction: column; gap: 6px; }
.invoice-layout-form-page .amazon-invoice-banner .banner-title { font-size: 24px; font-weight: 700; margin: 0; color: #fff; }
.invoice-layout-form-page .amazon-invoice-banner .banner-subtitle { font-size: 13px; color: rgba(255,255,255,0.78); margin: 0; }
.invoice-layout-form-page .amazon-invoice-banner .banner-action .btn-invoice-save {
    background: linear-gradient(to bottom, #FF9900 0%, #E47911 100%) !important;
    border-color: #C7511F !important; color: #fff !important; font-weight: 600; padding: 10px 24px; border-radius: 6px;
}
.invoice-layout-form-page .amazon-invoice-banner .banner-action .btn-invoice-save:hover { color: #fff !important; opacity: 0.95; }
.invoice-layout-form-page .invoice-section-card {
    margin-bottom: 20px; border-radius: 10px; overflow: hidden;
    box-shadow: 0 2px 8px rgba(0,0,0,0.1); border: 1px solid #D5D9D9;
}
.invoice-layout-form-page .invoice-section-header {
    background: linear-gradient(135deg, #232f3e 0%, #37475a 100%); color: #fff; padding: 14px 20px;
    display: flex; align-items: center; gap: 10px; font-size: 1rem; font-weight: 600; position: relative;
}
.invoice-layout-form-page .invoice-section-header::before {
    content: ''; position: absolute; top: 0; left: 0; right: 0; height: 3px; background: #ff9900;
}
.invoice-layout-form-page .invoice-section-header i { color: #fff; font-size: 18px; }
.invoice-layout-form-page .invoice-section-body {
    background: #f7f8f8; padding: 1.25rem 1.5rem;
}
.invoice-layout-form-page .invoice-section-body .form-group { margin-bottom: 0.75rem; }
.invoice-layout-form-page .invoice-section-body label { color: #0F1111 !important; font-size: 0.8125rem; }
.invoice-layout-form-page .invoice-section-body .form-control {
    background: #fff; border: 1px solid #D5D9D9; color: #0F1111;
    font-size: 0.8125rem; padding: 0.375rem 0.5rem; min-height: 2rem; box-sizing: border-box;
}
.invoice-layout-form-page .invoice-section-body .form-control:focus {
    border-color: #FF9900; outline: none; box-shadow: 0 0 0 2px rgba(255,153,0,0.2);
}
.invoice-layout-form-page .invoice-section-body input[type="checkbox"] { accent-color: #FF9900; }
.invoice-layout-form-page .invoice-section-body .checkbox label { color: #0F1111 !important; }
.invoice-layout-form-page .invoice-section-body .help-block { color: #565959; font-size: 0.8125rem; }
.invoice-layout-form-page .invoice-section-body h4 { color: #232F3E; font-size: 0.9375rem; margin: 0 0 0.75rem 0; }
</style>
@endsection
...
@endphp
<div class="invoice-layout-form-page">
  <div class="amazon-invoice-banner amazon-theme-banner">
    <div class="banner-inner">
      <div class="banner-icon"><i class="fa fa-file-invoice" aria-hidden="true"></i></div>
      <div class="banner-text">
        <h1 class="banner-title">@lang('invoice.add_invoice_layout')</h1>
        <p class="banner-subtitle">@lang('invoice.all_your_invoice_layouts')</p>
      </div>
    </div>
    <div class="banner-action">
      <button type="submit" form="add_invoice_layout_form" class="btn btn-invoice-save">@lang('messages.save')</button>
    </div>
  </div>
...
{!! Form::open(['url' => action([\App\Http\Controllers\InvoiceLayoutController::class, 'store']), 'method' => 'post', 'id' => 'add_invoice_layout_form', 'files' => true]) !!}
  ...
  <div class="invoice-section-card">
    <div class="invoice-section-header"><i class="fa fa-cog"></i> @lang('invoice.invoice_settings')</div>
  ...
  <div class="invoice-section-card">
    <div class="invoice-section-header"><i class="fa fa-heading"></i> @lang('invoice.invoice_heading') & @lang('lang_v1.invoice_no_prefix')</div>
    <div class="invoice-section-body">
    <div class="row">
        <div class="col-sm-3">
          <div class="form-group">
  ...
  <div class="invoice-section-card">
    <div class="invoice-section-header"><i class="fa fa-table"></i> @lang('lang_v1.product_label') & @lang('lang_v1.product_details_to_be_shown')</div>
    <div class="invoice-section-body">
      <div class="row">
        <div class="col-sm-3">
          <div class="form-group">
  ...
  <div class="invoice-section-card">
    <div class="invoice-section-header"><i class="fa fa-calculator"></i> @lang('invoice.sub_total_label') & @lang('invoice.total_label')</div>
    <div class="invoice-section-body">
      <div class="row">
        <div class="col-sm-3">
          <div class="form-group">
  ...
  <div class="invoice-section-card">
    <div class="invoice-section-header"><i class="fa fa-file-alt"></i> @lang('invoice.footer_text') & @lang('barcode.set_as_default')</div>
    <div class="invoice-section-body">
      <div class="row">
  ...
  <div class="invoice-section-card">
    <div class="invoice-section-header"><i class="fa fa-qrcode"></i> @lang('lang_v1.qr_code')</div>
    <div class="invoice-section-body">
  <div class="row">
    <div class="col-sm-4">
      <div class="form-group">
  ...
  @endif
  <div class="invoice-section-card">
    <div class="invoice-section-header"><i class="fa fa-sticky-note"></i> @lang('lang_v1.layout_credit_note')</div>
    <div class="invoice-section-body">
      <div class="row">
