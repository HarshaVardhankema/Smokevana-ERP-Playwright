<tr class="product_row">
    <input type="hidden" class="variation_id" value={{$product->variation_id}}>
    <td>
    ...
    <td class="show_price_with_permission">
        <input type="number" name="products[{{$row_index}}][unit_price]" class="form-control product_unit_price input_number" value="{{@num_format($product->last_purchased_price)}}" min="0" step="0.01">
    </td>
    <td class="show_price_with_permission">
