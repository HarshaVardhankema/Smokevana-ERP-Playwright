...
<body>
    <div class="email-wrapper">
        <div class="header">
            <img src="{{asset('img/gsw_emails-07_header.jpg')}}" alt="Header Image" style="width: 100%; height: auto;" />
            <div class="email-container">
                <div class="email-banner">
                    <div class="email-content">
                        <p class="name-class">Hello {{$Username}},</p>
                        <p class="matter">
                            Your password has been updated successfully. You can now sign in to
                            your {{ config('app.name') }} account.
                        </p>
                        <div class="button-section">
                            <a href="{{ config('app.front-url') . '/login-page'}}" class="explore-btn" target="_blank">Login</a>
                        </div>
                        <div class="footer">
