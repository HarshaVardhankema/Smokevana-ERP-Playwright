...
<body>
    ...
    <p>
        ...
        <br>
        <a href="{{ config('app.front-url') . '/set-password?token=' . $token . '&email=' . urlencode($email) }}">
Reset Password
</a>
</p>
...
<body>
    <div class="email-wrapper">
        <div class="header">
            <img src="{{ asset('img/gsw_emails-11_header.jpg') }}" alt="Header Image" style="width: 100%; height: auto;" />
