...
<section class="content-header tw-flex tw-justify-between">
    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <button type="button" id="submit_purchase_form" class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang('messages.update')</button>
      </div>
  </div>
  </section>
  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('components.widget', ['class' => 'box-primary', 'style' => 'z-index:999; position:relative;'])
        <div class="row">
            ...
            <div class="@if(!empty($default_purchase_status)) col-sm-1 @else col-sm-1 @endif">
              <div class="form-group">
            ...
            <div class="col-sm-1 @if(!empty($default_purchase_status)) hide @endif">
              <div class="form-group">
              ...
              <div class="tw-flex tw-justify-between">
                <div class="tw-flex tw-gap-6">
                  ...
                  <div class="form-group">
                    ...
                    {!! Form::text('shipping_charges', number_format($purchase->shipping_charges/$purchase->exchange_rate, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input_number','min' => '0', 'required']); !!}
                  </div>
                </div>
                <div>
                  <table class="pull-right ">
                    ...
                    <tr class=" hide">
                      <th class="text-left">@lang( 'purchase.total_before_tax' ):</th>
                      <td class=" text-left">
