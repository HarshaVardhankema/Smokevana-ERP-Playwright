...
@php
    $is_variation_value_hidden = !empty($variation_value_id) ? 0 : 0;
@endphp

<tr @if(!empty($variation_value_id)) 
        data-variation_value_id="{{$variation_value_id}}" 
        class="variation_value_row " 
    @endif>
    <td >
    ...
    <td>
        {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][var_barcode_no]', null, ['class' => 'form-control input-sm input_var_barcode_no']); !!}
    </td>
    <td>
        {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][var_maxSaleLimit]', null, ['class' => 'form-control input-sm input_var_maxSaleLimit']); !!}
    </td>
    ...
    <td class="{{$class}}">
        ...
        <div class="hide width-50 f-left">
    ...
    <td class="hide" style="display: none !important;">
        <div class="input-group">
            {!! Form::hidden($name . '[' . $variation_index . '][variations][' . $value_index . '][profit_percent]', $profit_percent, ['class' => 'variable_profit_percent']); !!}
        </div>
    </td>
    <td class="{{$class}}">
