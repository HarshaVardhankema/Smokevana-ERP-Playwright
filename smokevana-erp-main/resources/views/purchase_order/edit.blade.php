...
@section('css')
<style>
/* Amazon theme for Purchase Order Edit page */
...
<section class="content-header tw-flex tw-justify-between">
    ...
    <div class="row ">
      <div class="col-sm-12 text-center">
        <button type="button" id="submit_purchase_form" class="tw-dw-btn tw-dw-btn-primary tw-text-white" style="border-radius: 6px;">@lang('messages.update')</button>
      </div>
  </div>
...
<section class="content">
  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('components.widget', ['class' => 'box-primary', 'style' => 'z-index:999; position:relative;'])
        <div class="row">
          ...
          <div class="col-sm-2 @if(count($business_locations) == 1) hide @endif">
            <div class="form-group">
              {!! Form::label('location_id', __('purchase.business_location').':*') !!}
              @show_tooltip(__('tooltip.purchase_location'))
              {!! Form::select('location_id', $business_locations, $purchase->location_id, ['class' => 'form-control select', 'placeholder' => __('messages.please_select'), 'disabled']); !!}
            </div>
          </div>
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <button tabindex="-1" type="button" class="btn btn-link btn-modal"data-href="{{action([\App\Http\Controllers\ProductController::class, 'quickAdd'])}}" 
                      data-container=".quick_add_product_modal" style="border-radius: 6px;"><i class="fa fa-plus"></i> @lang( 'product.add_new_product' ) </button>
              </div>
            </div>
        </div> --}}
            ...
            <div class="col-sm-12">
              ...
              <div class="tw-flex tw-justify-between">
                <div class='tw-flex tw-gap-6'>
                  <div class="form-group ">
                    ...
                    <div class="input-group" style="display: flex">
                      ...
                      , ['class' => 'form-control input_number','id'=>'discount_amount','min'=>0]); !!}
                    {!! Form::select('discount_type', ['fixed' => '$', 'percentage' => '%'], $purchase->discount_type, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'),'id'=>'discount_type']); !!}
                  </div>
                  </div>
                ...
                <div >
                  <table>
                    <tr>
                      <th class=" text-left">@lang( 'lang_v1.total_items' ) : </th>
                      <td class=" text-right">
                    ...
                    <tr>
                      <th class=" text-left">@lang( 'purchase.net_total_amount' ):</th>
                      <td class=" text-right">
...
<div class="modal fade contact_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
  @include('contact.create', ['quick_add' => true])
   ...
   <div class="hide page_id" id={{$purchase->id}} transaction_type="Transaction"></div>
