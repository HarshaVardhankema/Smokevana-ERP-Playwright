    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'navigation_page_access', in_array('navigation_page_access', $role_permissions), 
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'home.view', in_array('home.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'home.access', in_array('home.access', $role_permissions), 
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
           ...
           <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_customer_group',in_array('view_customer_group', $role_permissions), 
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'complaint.view', in_array('complaint.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'complaint.create', in_array('complaint.create', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'complaint.update', in_array('complaint.update', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'complaint.delete', in_array('complaint.delete', $role_permissions), 
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'business_identification.view', in_array('business_identification.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'business_identification.create', in_array('business_identification.create', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'business_identification.update', in_array('business_identification.update', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'business_identification.delete', in_array('business_identification.delete', $role_permissions), 
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
           ...
           <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::radio('radio_option[stock_view]', 'stock.view',in_array('stock.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::radio('radio_option[stock_view]', 'view_own_stock', in_array('view_own_stock', $role_permissions), 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'order_fulfillment.held', in_array('order_fulfillment.held', $role_permissions), 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'ecom_controller', in_array('ecom_controller', $role_permissions), ['class' => 'input-icheck']) !!}
                    Ecom Controller
                  </label>
                </div>
              </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'ecom_contact_us', in_array('ecom_contact_us', $role_permissions), ['class' => 'input-icheck']) !!}
                  Contact Us Access
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'ecom_newsletter', in_array('ecom_newsletter', $role_permissions), ['class' => 'input-icheck']) !!}
                  Newsletter Access
                </label>
              </div>
            </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'pickerman', in_array('pickerman', $role_permissions), ['class' => 'input-icheck']) !!}
                  Consider Picker
                </label>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'pickerman.view', in_array('pickerman.view', $role_permissions), ['class' => 'input-icheck']) !!}
                Can View
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'pickerman.edit', in_array('pickerman.edit', $role_permissions), ['class' => 'input-icheck']) !!}
                Can Edit
              </label>
            </div>
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.access', in_array('bookkeeping.access', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.view_dashboard', in_array('bookkeeping.view_dashboard', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_chart_of_accounts', in_array('bookkeeping.manage_chart_of_accounts', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_journal_entries', in_array('bookkeeping.manage_journal_entries', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_bank_deposits', in_array('bookkeeping.manage_bank_deposits', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_accounts_receivable', in_array('bookkeeping.manage_accounts_receivable', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_accounts_payable', in_array('bookkeeping.manage_accounts_payable', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_liabilities', in_array('bookkeeping.manage_liabilities', $role_permissions), ['class' => 'input-icheck']) !!}
                  Manage Liabilities
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_partner_transactions', in_array('bookkeeping.manage_partner_transactions', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_inventory_valuation', in_array('bookkeeping.manage_inventory_valuation', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.manage_pl_transactions', in_array('bookkeeping.manage_pl_transactions', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.view_trial_balance', in_array('bookkeeping.view_trial_balance', $role_permissions), ['class' => 'input-icheck']) !!}
                  View Trial Balance
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'bookkeeping.view_reports', in_array('bookkeeping.view_reports', $role_permissions), ['class' => 'input-icheck']) !!}
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'vendor.view_portal', in_array('vendor.view_portal', $role_permissions), ['class' => 'input-icheck']) !!}
                  View Vendor Portal
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'vendor.manage_product_requests', in_array('vendor.manage_product_requests', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'vendor.assign_products', in_array('vendor.assign_products', $role_permissions), ['class' => 'input-icheck']) !!}
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.vendor.access_portal', in_array('dropship.vendor.access_portal', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.vendor.view_products', in_array('dropship.vendor.view_products', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.vendor.manage_stock', in_array('dropship.vendor.manage_stock', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.vendor.view_orders', in_array('dropship.vendor.view_orders', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.vendor.fulfill_orders', in_array('dropship.vendor.fulfill_orders', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.vendor.view_earnings', in_array('dropship.vendor.view_earnings', $role_permissions), ['class' => 'input-icheck']) !!}
                  View Earnings
                </label>
              </div>
            </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.admin.access_dashboard', in_array('dropship.admin.access_dashboard', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.admin.manage_vendors', in_array('dropship.admin.manage_vendors', $role_permissions), ['class' => 'input-icheck']) !!}
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'dropship.admin.view_all_orders', in_array('dropship.admin.view_all_orders', $role_permissions), ['class' => 'input-icheck']) !!}
