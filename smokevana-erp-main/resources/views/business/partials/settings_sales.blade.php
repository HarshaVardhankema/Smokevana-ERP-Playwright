<div class="pos-tab-content">
    {{-- Section: Default Sale Discount & Tax --}}
    <div class="settings-section-card">
        <h4 class="settings-section-title">@lang('business.default_sales_discount')</h4>
        <div class="row">
        <div class="col-sm-4">
    ...
    <div class="settings-section-card">
        <h4 class="settings-section-title">@lang('lang_v1.amount_rounding_method')</h4>
        <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('overselling_qty_limit', 'Overselling Quantity Limit:') !!}
                {!! Form::text('overselling_qty_limit', $business->overselling_qty_limit??null, ['class' => 'form-control input_number', 'placeholder' => 'Overselling Quantity Limit', 'id' => 'overselling_qty_lim']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                    {!! Form::checkbox('pos_settings[is_shipping]', 1, !empty($pos_settings['is_shipping']) , [ 'class' => 'input-icheck', 'id' => 'is_shipping']); !!} {{ "Shipping is required" }}
                    </label>
                </div>
            </div>
        </div>
    ...
    {{-- Section: Commission Agent --}}
    <div class="settings-section-card">
        <h4 class="settings-section-title">@lang('lang_v1.commission_agent'):</h4>
        <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
    ...
    {{-- Section: Payment Link (Razorpay, Stripe) --}}
    <div class="settings-section-card">
        <h4 class="settings-section-title">@lang('lang_v1.payment_link') @show_tooltip(__('lang_v1.payment_link_help_text')):</h4>
        <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
        ...
        <h4 class="settings-section-title settings-section-title--sub">Razorpay: <small class="tw-font-normal tw-text-gray-500">(For INR India)</small></h4>
        <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
        ...
        <h4 class="settings-section-title settings-section-title--sub">Stripe:</h4>
        <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
