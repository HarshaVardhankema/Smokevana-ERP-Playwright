        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
                // Calculate remaining due amount for max validation
                // Use the transactionUtil instance to get total paid
                ...
                // Only set max if there's a positive remaining due amount
                // If remaining is 0 or negative (overpaid), allow overpayment by not setting max
                $max_amount = $remaining_due > 0 ? $remaining_due : null;
              @endphp
              {!! Form::text("amount", $payment_line->amount, [
                'class' => 'form-control input_number payment_amount', 
                'required', 
                'placeholder' => 'Amount',
                'min' => 0.01, // Ensures no negative values are accepted
