<div class="modal-dialog shipstation-form-modal" role="document" style="max-width: 700px; width: 95%;">
    ...
    <style>
        /* === ShipStation Edit Modal - Amazon theme === */
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\ShipStationController::class, 'update'], $tax_rate->id),
            'method' => 'PUT',
            'id' => 'shipstation_edit_form',
        ]) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Edit ShipStation API (V2)</h4>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="shipstation-card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('api', 'Your Api-Key (V2)' . ':*') !!}
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                {!! Form::text('api', $tax_rate->api, ['class' => 'form-control', 'required', 'step' => 'any']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::number('priority', $tax_rate->priority, ['class' => 'form-control', 'required', 'step' => 'any']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group" style="margin-top: 1.75rem;">
                            <label>
                                {!! Form::checkbox('usable', 1, $tax_rate->usable); !!} Usable
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('contact_name', $tax_rate->contact_name, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('phone', $tax_rate->phone ?? null, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('company_name', $tax_rate->company_name, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('address_1', $tax_rate->address_1, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                                {!! Form::text('city_locality', $tax_rate->city_locality, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                                {!! Form::text('state_province', $tax_rate->state_province, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('postal_code', $tax_rate->postal_code, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('country_code', $tax_rate->country_code, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    </div>
                </div>
