			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-6">
						<div class="checkbox">
							<label>
				              	{!! Form::checkbox('search_fields[]', 'name', false, ['class' => 'input-icheck search_fields']); !!} @lang('product.product_name')
				            </label>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="checkbox">
							<label>
								{!! Form::checkbox('search_fields[]', 'var_barcode_no', false, ['class' => 'input-icheck search_fields']); !!} Barcode
							</label>
						</div>
					</div>
					<div class="col-md-6">
						<div class="checkbox">
							<label>
								{!! Form::checkbox('search_fields[]', 'sub_sku', true, ['class' => 'input-icheck search_fields']); !!} Variation SKU
							</label>
						</div>
					</div>
