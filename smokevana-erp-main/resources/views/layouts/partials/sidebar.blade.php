...
<aside
    class="side-bar tw-relative tw-hidden tw-h-full tw-bg-white tw-w-64 xl:tw-w-64 lg:tw-flex lg:tw-flex-col tw-shrink-0 no-print">
    ...
    <a href="{{ route('home') }}"
        ...
        <p class="tw-text-lg tw-font-medium tw-text-white side-bar-heading tw-text-center">
            ...
            {{-- <span class="tw-inline-block tw-w-3 tw-h-3 tw-bg-green-400 tw-rounded-full" title="Online"> --}}
