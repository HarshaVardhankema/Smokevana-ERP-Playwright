...
<div class="tw-flex tw-justify-between tw-items-center tw-gap-4 " style="margin-top: -10px">
<h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.edit_purchase_return')</h1>
<button type="button" id="submit_purchase_return_form" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-md tw-text-white tw-mb-2">@lang('messages.update')</button>
</div>
</section>
								...
								<td colspan="2">
									<div class="form-group">
										<div class="input-group">
											...
											{!! Form::text('search_product', null, ['class' => 'form-control mousetrap ui-autocomplete-input', 'id' => 'search_product_for_purchase_return', 'placeholder' => __('lang_v1.search_product_placeholder'), ]); !!}
											{{-- <span class="input-group-btn">
