{{-- data table for payment group --}}
@if(($contact_type == 'both' || $contact_type == 'customer'))
<div id="contact_payment_group_div" class="mt-3">
    <table class="table table-bordered table-striped" id="contact_payment_group_table">
        <thead>
            <tr>
                <th>Group Ref No</th>
                <th>Group Name</th>
