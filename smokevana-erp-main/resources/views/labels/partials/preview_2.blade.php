...
@foreach($page_products as $page_product)
	...
	@endif
		<td align="center" valign="center" style="background-color: #ffffff !important;">
			<div style="overflow: hidden !important;display: flex; flex-wrap: wrap;align-content: center;width: {{$barcode_details->width * 1}}in; height: {{$barcode_details->height * 1}}in; justify-content: center; background-color: #ffffff;">
				...
				<div>
					...
					@endif
					{{-- Barcode --}}
					<img style="max-width:90% !important;height: {{$barcode_details->height*0.24}}in !important; display: block;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($page_product->var_barcode_no??$page_product->sub_sku, $page_product->barcode_type, 1,30, array(0, 0, 0), false)}}">
					
					<span style="font-size: 10px !important">
						{{$page_product->var_barcode_no??$page_product->sub_sku}}
					</span>
				</div>
			</div>
