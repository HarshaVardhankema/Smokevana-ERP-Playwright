<div class="modal-dialog amazon-form-modal modal-xl" role="document" style="max-width: 1100px; width: 95%;">
  <div class="modal-content">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="amazon-file-preview" id="brand_logo_preview"></div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="amazon-file-preview" id="brand_banner_preview"></div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => 'Enter brand name']); !!}
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::text('slug', null, ['class' => 'form-control', 'placeholder' => 'auto-generated-slug']); !!}
                  </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'Enter a short brand description...', 'rows' => 3]); !!}
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::url('brand_url', null, ['class' => 'form-control', 'placeholder' => 'https://example.com']); !!}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    {!! Form::select('category', $brandCategory ?? [], null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2 select_category_id']); !!}
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    ], 'public', ['class' => 'form-control', 'required']); !!}
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="modal-footer">
      <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white"><i class="fas fa-check"></i> Save Brand</button>
