...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            // Business Identification Permissions
            ['name' => 'business_identification.view'],
            ['name' => 'business_identification.create'],
            ['name' => 'business_identification.update'],
            ['name' => 'business_identification.delete'],
