...
class CombinedPurchaseReturnController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        // \Log::info('Purchase Return Save - Request Data:', $request->all());
        ...
        try {
            ...
            if (! empty($products)) {
                ...
                // Debug: Log when products array is empty
                Log::warning('Purchase Return Save - Products array is empty or null');
            }
