...
class PurchaseReturnController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($purchases_returns)
                ...
                ->rawColumns(['final_total', 'action','name', 'payment_status', 'parent_purchase', 'payment_due'])
                ->make(true);
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $return_prices = $request->input('return_prices');
            $return_total = 0;
            ...
            foreach ($purchase->purchase_lines as $purchase_line) {
                ...
                $return_price = ! empty($return_prices[$purchase_line->id]) ? $this->productUtil->num_uf($return_prices[$purchase_line->id]) : $purchase_line->purchase_price_inc_tax;
                ...
                $purchase_line->save();
                $return_total += $return_price * $purchase_line->quantity_returned;
