    ...
    public function add($product_id)
    {
        ...
        $product = Product::where('business_id', $business_id)
            ...
            ->with([
                ...
                'variations.variation_location_details', //custom line
                'unit',
                'product_locations',
                'second_unit',
            ])
                    ...
                    if (array_key_exists($location_id, $locations)) {
                        foreach ($value as $vid => $purchase_lines_data) {
                            ...
                            foreach ($purchase_lines_data as $k => $pl) {
                                ...
                                $in_stock_qty = (int) $pl['in_stock_qty'];
                                ...
                                if (isset($pl['purchase_line_id'])) {
                                    ...
                                    if ($qty_remaining != 0) {
                                        ...
                                        // custom start update added instock quantity
                                        try {
                                            ...
                                            if ($product->enable_stock == 1) {
                                                ...
                                                $variation_location_d = VariationLocationDetails::where('variation_id', $variation->id)
                                                    ...
                                                    ->first();
                                                $variation_location_d->in_stock_qty = $in_stock_qty;
