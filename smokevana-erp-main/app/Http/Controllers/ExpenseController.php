        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($expenses)
                ...
                ->addColumn('contact_name', function ($data) {
                    $name= $data->contact_name . ' ' . $data->supplier_business_name;
                    $id = $data->Cid;
                ...
                ->addColumn('expense_for', function ($row) {
                    $id = $row->Uid??'';
                    if ($id) {
                ...
                ->rawColumns(['final_total', 'action', 'payment_status', 'payment_due', 'ref_no', 'recur_details','expense_for','added_by','contact_name'])
                ->make(true);
        }
