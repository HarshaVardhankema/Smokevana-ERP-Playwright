    ...
    public function availableModules()
    {
        return [
            ...
            'prime_subscription' => [
                ...
                'tooltip' => 'Enable Prime Subscriptions module (plans, benefits, and customer Prime status).',
            ],
            'types_of_service' => ['name' => __('lang_v1.types_of_service'),
                'tooltip' => __('lang_v1.types_of_service_help_long'),
            ],
            'woocommerce' => ['name' => __('Woocommerce')],
            'vendor' => ['name' => __('Vendor Portal'),
                'tooltip' => __('Vendor Portal module for managing vendor access, product requests, and approvals.'),
            ],
            'group_pricing' => ['name' => __('Group Pricing')],
            'sales_returns' => ['name' => __('Sales Returns')],
            "credit_line" => ['name' => __('Credit Line')],
            'supportagent' => [
                'name' => __('AI Support Agent'),
                'tooltip' => __('AI-powered assistant to help users understand and use system features.'),
            ],
            'complaints' => [
                'name' => __('lang_v1.enable_complaints'),
                'tooltip' => __('lang_v1.enable_complaints_help_text'),
            ],
        ];
    }
