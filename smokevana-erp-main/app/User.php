...
class User extends Authenticatable
{
    ...
    /**
     * Get all visit tracking records for the user.
     */
    public function visitTracking()
    {
        return $this->hasMany(\App\VisitTracking::class, 'sales_rep_id');
    }
     ...
     * @return array users
     */
    public static function forDropdown($business_id, $prepend_none = true, $include_commission_agents = false, $prepend_all = false, $check_location_permission = false ,$only_cmmsn_agnt = false)
    {
