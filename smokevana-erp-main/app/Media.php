...
class Media extends Model
{
    ...
    public static function attachMediaToModel($model, $business_id, $uploaded_files, $request = null, $model_media_type = null, $custID=null)
    {
        if (! empty($uploaded_files)) {
            if (is_array($uploaded_files)) {
                ...
                foreach ($uploaded_files as $value) {
                    $media_obj[] = new \App\Media([
                        ...
                        'uploaded_by' => ! empty($request->uploaded_by) ? $request->uploaded_by : auth()->user()->id?? $custID,
