...
return [
    ...
    */
    ...
    'referal_program' => 'Referal Program',
    ...
    'enable_referal_program' => 'Enable Referral Program',
    'referal_program_custom_discount' => 'Custom Discount',
    'select_custom_discount' => 'Select Custom Discount',
    'select_custom_discount_help' => 'Select one or more discount rules to apply for referral program',
    'referal_sent_to_both_sides' => 'Send Referral to Both Sides',
    'referal_available_for_b2b' => 'Available for B2B',
    'referal_available_for_b2c' => 'Available for B2C',
    'referal_brand_list' => 'Brand List',
    'referal_brand_list_placeholder' => 'fill brand ids separated by comma (e.g. 1,2,3)',
    'referal_brand_list_help' => 'Keep empty if want for all brands',
];
