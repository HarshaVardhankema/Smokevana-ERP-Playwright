...
return [
    ...
    'quantities_synced_from_woo_successfully' => 'Product quantities synced from WooCommerce successfully',
    'price_group_mapping_settings' => 'Price Group Mapping Settings',
    'price_group_mapping_help' => 'Configure which WooCommerce price types map to which ERP price groups',
    'woocommerce_price_type' => 'WooCommerce Price Type',
    'erp_price_group' => 'ERP Price Group',
    'price_group_id' => 'Price Group ID',
    'status' => 'Status',
    'price_mapping_info' => 'Price Mapping Information',
    'price_mapping_info_1' => 'Configure which WooCommerce price types should be mapped to ERP price groups',
    'price_mapping_info_2' => 'Only enabled mappings will be used during product synchronization',
    'price_mapping_info_3' => 'Each price type can be mapped to a different ERP price group',
];
