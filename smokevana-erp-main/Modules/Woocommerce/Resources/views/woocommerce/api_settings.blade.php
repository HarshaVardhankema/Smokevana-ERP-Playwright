                ...
                @component('components.widget', ['class' => 'pos-tab-container'])
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item text-center tw-font-bold tw-text-sm md:tw-text-base">Price Group Mapping</a>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                        ...
                        @include('woocommerce::woocommerce.partials.price_group_mapping_settings')
